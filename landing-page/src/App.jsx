...
function App() {
  return (
    <div className="App fixed flex flex-col w-full min-h-screen bg-[#f8f8f8] dark:bg-[#17161B] transition-all duration-300 ">
      <NavBar />
      <span className=" text-7xl text-black dark:text-white font text-center mt-28 font-medium">Find your ideal home</span>
      <div className="w-[825px] h-[76px] mx-auto mt-6">
