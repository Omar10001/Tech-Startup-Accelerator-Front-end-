...
function App() {
  return (
    <div className="App fixed flex flex-col px-1 w-full md:min-h-screen bg-[#f8f8f8] dark:bg-[#17161B] transition-all duration-300 ">
      <NavBar />
      ...
      <footer className="absolute z-10 h-fit md:h-[50px] bg-transparent md:bg-white dark:bg-[#17161B] bottom-0 flex flex-col md:flex-row gap-6 md:gap-0 justify-between items-center w-full px-20 transition-colors duration-300">
